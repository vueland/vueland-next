...
export const VDataTable = defineComponent({
  ...
  setup(props, {
    ...
    watch(() => props.rows, to => rows.value = copyWithoutRef(to), {
      immediate: true
    });
    ...
    return () => {
      ...
      return h('div', setBackground(props.color, propsData), [genTableTools(), genTableInner(), genTableFooter(), genColsSettingsModal()]);
    };
  }
