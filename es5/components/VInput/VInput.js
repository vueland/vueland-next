...
var VInput = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    function genInputSlot() {
      ...
      return (0, _vue.h)('div', props.color ? setTextColor(props.color, propsData) : propsData, [genSlotContent(), genStatus()]);
    }
    ...
    function genSlotContent() {
      ...
      return (0, _vue.h)('div', propsData, [props.prependIcon && genPrependIcon(), !props.clearable && props.appendIcon && genAppendIcon(), props.clearable && genClearIcon(), genLabel(), slots.select && slots.select(), slots.textField && slots.textField()]);
    }
