...
exports.VDates = void 0;

require("../../../src/components/VDatePicker/VDates.scss");
...
var VDates = (0, _vue.defineComponent)({
  name: 'v-dates',
  props: {
    localeWeek: Array,
    year: [String, Number],
  ...
  setup: function setup(props, _ref) {
    ...
    function genDateRows() {
      ...
      return (0, _helpers.genTableRows)(datesVNodes, 'v-dates__row', WEEK.length);
    }
