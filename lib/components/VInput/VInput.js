...
import { h, watch, computed, defineComponent, inject, onBeforeUnmount } from 'vue';
...
export const VInput = defineComponent({
  ...
  setup(props, {
    ...
    watch(() => props.focused, to => !to && validateValue());
    ...
    function genStatus() {
      const transitionedMessage = useTransition(errorState.innerErrorMessage && genStatusMessage(), 'fade');
      const propsData = {
