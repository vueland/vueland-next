...
export const VDataTableHeader = defineComponent({
  ...
  setup(props, {
    ...
    function genFilterWrapper(item) {
      ...
      return item.filterable && withDirectives(h('div', setBackground(props.color, propsData), [genFilterHeader(item), genFilterInput(item)]), [[clickOutside, directive], [vShow, item.addFilter]]);
    }
