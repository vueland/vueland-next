...
var VDataTableCell = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    function genResize() {
      ...
      return (0, _vue.h)(_VResize.VResize, propsData);
    }
    ...
    return function () {
      var color = props.contentColor || (props.dark ? 'white' : '');
      ...
      return (0, _vue.h)('div', props.color ? setBackground(props.color, propsData) : propsData, [genCellContent(), props.resizeable && genResize()]);
    };
  }
});
